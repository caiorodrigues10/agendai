...
## Corpus Check
- 139 files · ~111,319 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 926 nodes · 1925 edges · 95 communities (56 shown, 39 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 7 edges (avg confidence: 0.63)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `067787f8`
...
Cohesion: 0.24
Nodes (11): PublicLinkPanel(), PublicLinkPanelProps, ALL_TAB_IDS, canAccessTab(), getDefaultTab(), TAB_GROUPS, TabDef, TabGroup (+3 more)

### Community 1 - "LoginPage.tsx"
Cohesion: 0.16
Nodes (17): FinancialDashboardProps, PackageCatalog(), QueueItemCardProps, ReturnToQueueModal(), ReturnToQueueModalProps, ServiceCardProps, ServiceForm(), ServiceFormProps (+9 more)

### Community 2 - "OwnerFinancialPanel.tsx"
Cohesion: 0.05
Nodes (43): react, react, brl(), FinancialDashboard(), isOwnerLike(), brl, EMPTY_EXPENSE_FORM, EMPTY_META (+35 more)

### Community 3 - "schedulingUtils.ts"
Cohesion: 0.10
Nodes (22): fieldClass(), formatPrice(), brl, PAYMENT_LABEL, STATUS_LABEL, STATUS_STYLE, brl, emptyForm (+14 more)

### Community 4 - "devDependencies"
Cohesion: 0.29
Nodes (7): autoprefixer, eslint, devDependencies, autoprefixer, eslint, @typescript-eslint/eslint-plugin, @typescript-eslint/eslint-plugin
...
Cohesion: 0.15
Nodes (13): class-variance-authority, @hookform/resolvers, lucide-react, dependencies, class-variance-authority, @hookform/resolvers, lucide-react, react-day-picker (+5 more)
...
Cohesion: 0.20
Nodes (14): ACCESS_BLOCKED_CODES, AccessBlockedCode, apiClient(), ApiError, buildApiError(), calls, checkRateLimit(), HttpMethod (+6 more)
...
Cohesion: 0.07
Nodes (32): Avatar(), AvatarProps, AvatarSize, COLORS, getColorClass(), getInitials(), SIZE_MAP, Header() (+24 more)

### Community 15 - "MarketingFooter.tsx"
Cohesion: 0.33
Nodes (6): platformWhatsAppUnavailable(), SalonWhatsAppConnection(), SettingsManager(), SettingsManagerProps, barbershopApi, ShopWhatsAppStatus
...
Cohesion: 0.06
Nodes (57): AddCustomerForm(), AddCustomerFormProps, clientPhoneLabel(), ClientsManager(), ServiceCard(), formatPrice(), TrialExpiredPaywallModal(), TrialExpiredPaywallModalProps (+49 more)
...
Cohesion: 0.29
Nodes (9): PricingPersuasionCharts(), formatPrice(), matrix, objections, PlansPage(), hasPanelAccess(), isPaidSubscription(), needsPaywallAfterAuth() (+1 more)
...
Cohesion: 0.15
Nodes (13): AddPostPayload, AddServicePayload, BarbershopData, CreatePostPayload, GeneratePostPayload, PostConfigPayload, StaffPayload, UpdateBarbershopPayload (+5 more)

### Community 25 - "FeaturesPage.tsx"
Cohesion: 0.13
Nodes (19): AppointmentCalendarProps, busyCopy(), BusyLevel, busyStyles(), QueueStatusCard(), QueueStatusCardProps, SchedulingContext, SchedulingContextValue (+11 more)

### Community 26 - "CookieConsent.tsx"
Cohesion: 0.12
Nodes (20): AccountPrivacyPanel(), AccountPrivacyPanelProps, ROLE_LABEL, token(), AuthContext, AuthContextValue, AuthResult, useAuth() (+12 more)
...
Cohesion: 0.22
Nodes (4): ErrorBoundary, Props, State, logger

### Community 41 - "eslint-config-prettier"
Cohesion: 0.19
Nodes (13): ProfileAvatarSection(), ProfileAvatarSectionProps, QueueItemCard(), TeamManager(), TeamManagerProps, usersApi, TeamMemberFormData, TeamMemberSchema (+5 more)
...
Cohesion: 0.19
Nodes (14): AgendaView, AppointmentCalendar(), getDaysInMonth(), getFirstDayOfMonth(), MONTH_NAMES, WEEKDAYS, DaySchedule, DAY_NAMES (+6 more)

### Community 64 - "autoprefixer"
Cohesion: 0.18
Nodes (8): PricingPersuasionChartsProps, trialCampaign, highlights, pricing, screenshots, beats, beliefs, friendships

### Community 65 - "OwnerSubscriptionPanel.tsx"
Cohesion: 0.36
Nodes (13): AppointmentBookingModal(), AppointmentScheduler(), firstOpenDate(), BookPackageSessionsModal(), PickedSlot, parseLocalISO(), ThemedCalendar(), ThemedCalendarProps (+5 more)

### Community 67 - "QueueItemCard.tsx"
Cohesion: 0.28
Nodes (3): authStorage, notificationsApi, SendWhatsAppPayload
...
Cohesion: 0.18
Nodes (11): downloadPostImage(), MODE_LABEL, MODE_OPTIONS, PostsManager(), PostTone, PostType, TONE_OPTIONS, TYPE_OPTIONS (+3 more)
...
Cohesion: 0.20
Nodes (10): scripts, build, dev, format, format:check, lint, lint:fix, preview (+2 more)

### Community 77 - "CheckoutPage.tsx"
Cohesion: 0.39
Nodes (9): AppointmentBookingModalProps, AppointmentSchedulerProps, BookPackageSessionsModalProps, ClientsManagerProps, ShopProfileProps, BarbershopContextValue, FeedPost, ShopSettings (+1 more)
...
Cohesion: 0.19
Nodes (12): AuthProvider(), BarbershopContext, BarbershopProvider(), isShopStaffRole(), BarbershopFiltersContext, BarbershopFiltersProvider(), BarbershopFiltersValue, DateRange (+4 more)
...
Cohesion: 0.19
Nodes (8): MarketingNav(), pageLinks, scrollToSection(), sectionLinks, daySlots, flowSteps, pros, sections
...
## Knowledge Gaps
- **319 isolated node(s):** `name`, `private`, `version`, `node`, `type` (+314 more)
...
- **Why does `dependencies` connect `dependencies` to `OwnerFinancialPanel.tsx`, `AuthContext.tsx`, `clsx`, `framer-motion`, `@google/genai`, `gsap`, `react-dom`, `react-focus-lock`, `react-router-dom`, `tailwind-merge`, `uuid`, `zod`?**
  _High betweenness centrality (0.183) - this node is a cross-community bridge._
- **Why does `react` connect `OwnerFinancialPanel.tsx` to `OwnerSubscriptionPanel.tsx`, `subscriptionsApi.ts`, `ShopProfile.tsx`, `dependencies`?**
  _High betweenness centrality (0.181) - this node is a cross-community bridge._
- **Why does `devDependencies` connect `devDependencies` to `StaffMember`, `jsdom`, `playwright`, `prettier`, `tailwindcss`, `@tailwindcss/postcss`, `@testing-library/jest-dom`, `@testing-library/react`, `@types/react`, `typescript`, `typescript-eslint`, `@typescript-eslint/parser`, `vite`, `@vitejs/plugin-react`, `vitest`, `@vitest/coverage-v8`, `eslint-plugin-react-hooks`, `postcss`, `@types/node`, `vite-plugin-pwa`, `@testing-library/user-event`, `AuthContext.tsx`, `QueueStatusCard.tsx`, `eslint-plugin-jsx-a11y`?**
