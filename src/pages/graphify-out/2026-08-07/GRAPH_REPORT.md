...
- 15 files · ~38,135 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary

- 124 nodes · 129 edges · 17 communities (16 shown, 1 thin omitted)
...
Cohesion: 0.29
Nodes (5): FieldProps, inputClass(), LoginPage(), QUEUE_MOCK, Tab
...
Cohesion: 0.50
Nodes (4): ContactFormData, ContactPage(), ContactSchema, inputClass()
...
- **46 isolated node(s):** `BlockInfo`, `PayMethod`, `REJECTION_MESSAGES`, `marqueeItems`, `queueCustomers` (+41 more)
