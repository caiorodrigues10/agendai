	...
	useLayoutEffect(() => {
		...
		const context = gsap.context(() => {
			media.add('(prefers-reduced-motion: no-preference)', () => {
				...
				const insightLine = page.querySelector<SVGPathElement>(
					'[data-insight-line]',
				)
				if (insightLine) {
				...
				const bookingCard = page.querySelector<HTMLElement>(
					'[data-booking-card]',
				)
				if (bookingCard) {
					const bookingDays = bookingCard.querySelectorAll('[data-booking-day]')
					const bookingSlots = bookingCard.querySelectorAll(
						'[data-booking-slot]',
					)
					const bookingConfirm = bookingCard.querySelector(
			...
			media.add('(prefers-reduced-motion: no-preference)', () => {
				...
				const stackItems =
					gsap.utils.toArray<HTMLElement>('[data-stack-item]')
				const progressFill = page.querySelector<HTMLElement>(
					'[data-stack-progress]',
				)
			...
			const stickyAnchor = page.querySelector<HTMLElement>(
			...
			if (stickyCta && stickyAnchor) {
				const stickyButton =
					stickyCta.querySelector<HTMLButtonElement>('button')
	...
	return (
		...
		>
			...
			<main className="relative z-10">
				<section className="relative flex min-h-screen items-center overflow-hidden px-5 pb-24 pt-28 sm:px-8 md:pt-32 xl:px-12 xl:pb-28 xl:pt-36">
					...
					<div className="relative z-10 mx-auto grid w-full max-w-400 items-center gap-16 xl:grid-cols-[minmax(0,0.95fr)_minmax(560px,1.05fr)] xl:gap-16 2xl:gap-24">
						<div className="relative z-20 max-w-3xl">
							...
							>
								Fila pública com estimativa de espera, agendamento online e
								financeiro no mesmo painel. A equipe opera em tempo real; você
							...
							<div
								data-hero-action
								className="mt-10 max-w-2xl border-t border-white/10 pt-6"
							>
									...
									<div className="grid gap-4 px-4 pb-4 md:grid-cols-[1.15fr_0.85fr]">
										...
										<div className="flex flex-col rounded-2xl border border-white/6 bg-black/20 p-4">
											...
											<div className="mt-6 flex min-h-32 flex-1 items-end gap-2">
												{[36, 55, 43, 72, 62, 88, 68, 96, 78].map(
													(height, index) => (
														<div
															key={index}
															data-hero-bar
					...
					<div className="mx-auto max-w-375">
						<div data-reveal className="mb-16 max-w-3xl">
							...
							<p className="mt-6 max-w-xl text-lg font-light leading-relaxed text-neutral-400 md:text-xl">
								O link público organiza a chegada, o painel coordena a equipe e
								o financeiro mostra o resultado — sem papel na recepção ou
								planilha paralela.
							</p>
						</div>
						...
						<div
							id="recursos"
							className="scroll-mt-28 space-y-28 md:space-y-36"
						>
							{/* Sessão 1 — Fila */}
							<article
								data-reveal
							...
							>
								<div>
									...
									<p className="mt-6 max-w-md text-lg font-medium leading-relaxed text-neutral-400">
										Entra pelo link, vê a posição e a estimativa. No painel, a
										equipe chama, inicia e conclui — sem gritar nome na porta.
									</p>
							...
							>
								<div className="order-2 lg:order-1">
									<div className="rounded-[1.75rem] border border-white/8 bg-[#0b0e0c] p-5 md:p-6">
										<div className="mb-5 flex items-baseline justify-between gap-3">
											...
											<p className="text-xs font-semibold tabular-nums text-cyan-300">
												Qui, 15
											</p>
										</div>
								...
								<div className="order-1 lg:order-2">
									...
									<p className="mt-6 max-w-md text-lg font-medium leading-relaxed text-neutral-400">
										Expediente, profissional e duração do serviço entram no
										cálculo. O cliente marca sem “tem vaga?” no WhatsApp.
									</p>
									<ul className="mt-8 space-y-3">
										{[
							...
							>
								<div>
									...
									<p className="mt-6 max-w-md text-lg font-medium leading-relaxed text-neutral-400">
										Entradas, custos e fiado no mesmo resumo. Você vê o líquido
										e o que ainda está na rua.
									</p>
									<ul className="mt-8 space-y-3">
										{[
							...
							>
								<div>
									...
									<p className="mt-6 max-w-md text-lg font-medium leading-relaxed text-neutral-400">
										O login define a tela: a equipe opera fila, agenda e
										serviços; o dono cuida de caixa, relatórios e assinatura.
									</p>
					...
					<div className="mx-auto grid max-w-375 gap-12 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:items-start lg:gap-16 xl:gap-20">
						<div data-reveal className="lg:sticky lg:top-32 lg:self-start">
							...
							<p className="mt-6 max-w-md text-base font-light leading-relaxed text-neutral-400 md:text-lg">
								Da chegada ao resultado, cada pessoa vê apenas o que precisa —
						...
						<div className="relative z-10 grid gap-14 p-8 md:p-16 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:p-24">
							<div>
								...
								<p className="mt-8 max-w-2xl text-xl font-medium leading-relaxed text-emerald-950/75 md:text-2xl">
									Acompanhe movimento, tempo de espera e resultado financeiro. A
									AgendAI transforma a rotina do estabelecimento em uma visão
									simples para agir.
								</p>
									...
									<div className="relative mt-10 h-56">
										<div className="absolute inset-0 flex flex-col justify-between">
											{[0, 1, 2, 3, 4].map((line) => (
												<div
													key={line}
													className="h-px w-full bg-emerald-950/10"
												/>
											))}
										</div>
										<svg
					...
					<div className="relative z-10 mx-auto max-w-375">
						<div data-reveal className="mb-14 max-w-3xl md:mb-20">
							...
							<p className="mt-6 max-w-2xl text-lg font-medium leading-relaxed text-neutral-400 md:text-xl">
								Trial completo, agenda o dia inteiro, anual com desconto real e
								entrada acessível. Sem cartão na porta — e sem surpresa na
								saída.
							</p>
						</div>
						...
						>
							{[
								...
								},
								{
									...
									detail:
										'Cliente marca sozinho — você para de atender “tem vaga?”.',
								},
								{
									value: 2,
									suffix: '',
								...
								},
								{
									...
									title: 'pra entrar',
									detail:
										'Essencial com fila, agenda e equipe — sem taxa por cadeira.',
								},
							].map((fact) => (
								<div
									key={fact.title}
				...
				<section
					id="precos"
					className="relative scroll-mt-16 px-6 py-28 md:py-40"
				>
					...
					<div className="relative z-10 mx-auto max-w-6xl">
						<div data-reveal className="mx-auto mb-12 max-w-3xl text-center">
							...
							<p className="mx-auto mt-6 max-w-2xl text-lg font-light leading-relaxed text-neutral-400">
								{trialCampaign.body} {trialCampaign.afterTrial} A diferença
								depois é só R$ 6 por mês.
							</p>
						</div>
						...
						>
							...
							>
								...
								<div className="relative z-10 mt-8">
									<div className="flex items-end gap-2">
										<span className="mb-2 text-base font-bold text-neutral-500">
											R$
										</span>
									...
									<p className="mt-4 text-sm font-medium leading-relaxed text-neutral-500">
										Fila, agenda e equipe ilimitada — o salão rodando sem taxa
										por cadeira.
									</p>
								</div>
							...
							>
								...
								<div className="relative z-10 mt-8">
									<div className="flex items-end gap-2">
										<span className="mb-2 text-base font-bold text-emerald-400">
											R$
										</span>
										<span className="text-6xl font-black tracking-[-0.06em] text-white md:text-7xl">
											20
									...
									<p className="mt-4 text-sm font-medium leading-relaxed text-neutral-300">
										Tudo do Essencial + dashboard, financeiro, fiado e insights.
										R$ 6 a mais que o Essencial.
									</p>
								</div>
