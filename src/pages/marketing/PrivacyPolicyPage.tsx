...
import { LuArrowRight as ArrowRight, LuShieldCheck as ShieldCheck } from 'react-icons/lu';
...
export const PrivacyPolicyPage: React.FC = () => {
  return (
    <div className="min-h-screen overflow-x-hidden bg-black font-sans text-neutral-100 selection:bg-accent/30">
      <SeoHead
        title="Política de Privacidade — LGPD | AgendAI"
        description="Transparência sobre como o AgendAI trata seus dados. Conformidade com a LGPD, dados isolados por salão e senhas criptografadas."
        path="/privacidade"
      />
        ...
        <div className="mx-auto max-w-3xl">
          ...
          >
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-accent/20 bg-accent/5 px-3 py-1 text-[10px] font-black uppercase tracking-[0.2em] text-accent">
              <ShieldCheck size={24} className="h-3.5 w-3.5" />
              Privacidade e LGPD
            </div>
