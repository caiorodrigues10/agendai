...
export const AboutPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-black font-sans text-neutral-100 selection:bg-accent/30">
          ...
          <div className="grid items-end gap-14 lg:grid-cols-[1.15fr_0.85fr] lg:gap-16">
            <div>
              ...
              >
                O corte muda.
                <br />
                <span className="text-accent">A conversa fica.</span>
              </motion.h1>
              <motion.p
            ...
            <motion.div
              ...
              className="relative overflow-hidden rounded-4xl border border-white/10 bg-surface p-7 md:p-8"
            >
              <div className="absolute -right-10 -top-10 h-40 w-40 rounded-full bg-accent/12 blur-[60px]" />
              ...
              <p className="relative z-10 mt-5 text-2xl font-black leading-snug tracking-tight text-white md:text-3xl">
                ...
                <br />
                <span className="text-accent-light">É um vínculo.</span>
              </p>
        ...
        <div className="mx-auto max-w-375">
          ...
          >
            <p className="text-3xl font-black leading-[1.15] tracking-tight text-white md:text-5xl md:leading-[1.1]">
              ...
              <span className="bg-gradient-to-r from-accent-light via-teal-200 to-white bg-clip-text text-transparent">
                {' '}
            ...
            {friendships.map((item, i) => {
              ...
              return (
                <motion.article
                  ...
                  className={`group relative overflow-hidden rounded-4xl border bg-surface p-7 transition-colors md:p-8 ${border}`}
                >
                  <div
      ...
      <section className="relative z-10 border-y border-white/8 bg-[#070a08] px-6 py-24 md:px-10 md:py-32 xl:px-12">
        <div className="mx-auto max-w-375">
          ...
          <div className="relative grid gap-0 md:grid-cols-3">
            <div className="pointer-events-none absolute left-[16%] right-[16%] top-8 hidden h-px bg-linear-to-r from-accent/30 via-white/15 to-amber-300/30 md:block" />
            {beats.map((beat, i) => (
              <motion.div
                key={beat.n}
              ...
              >
                <span className="text-sm font-black text-accent">{beat.n}</span>
        ...
        <div className="mx-auto max-w-375">
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="relative overflow-hidden rounded-4xl border border-accent/20 bg-surface"
            >
      ...
      <section className="relative z-10 px-6 py-24 md:px-10 md:py-32 xl:px-12">
        <div className="mx-auto max-w-375">
          <div className="overflow-hidden rounded-[2.5rem] border border-white/10 bg-surface md:rounded-[3rem]">
            <div className="grid lg:grid-cols-[1.1fr_0.9fr]">
              <div className="p-8 md:p-12 lg:p-16">
                <div className="flex items-center gap-3 mb-5">
                  <div className="h-px w-10 bg-gradient-to-r from-accent to-transparent" />
                  <p className="text-[11px] font-bold uppercase tracking-[0.3em] text-accent/90">
                    De onde viemos
                  </p>
                </div>
              ...
              <div className="relative flex flex-col justify-end border-t border-white/8 bg-gradient-to-br from-white/[0.03] to-transparent p-8 md:p-12 lg:border-l lg:border-t-0 lg:p-16">
                ...
                <p className="relative text-6xl font-black tracking-tighter md:text-8xl">
                  ...
                  <br />
                  <span className="text-accent/70">o vínculo</span>
                </p>
