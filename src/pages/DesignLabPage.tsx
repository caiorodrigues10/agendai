...
const PANELS: PanelDef[] = [
  ...
  },
  {
    ...
    hex: '#249B76',
    usage: 'Verde de marca mais presente, reduzido no volume sem perder identidade.',
    tokens: {
      '--dl-accent': '#249B76',
      '--dl-accent-hover': '#1C7E61',
      '--dl-accent-fg': '#ffffff',
      '--dl-surface': '#f6f8f5',
      '--dl-surface-2': '#e9eee9',
      '--dl-bg': '#fbfcfa',
      '--dl-border': '#d8e5dd',
      '--dl-border-strong': '#abc5b7',
      '--dl-text-primary': '#16251e',
      '--dl-text-secondary': '#4d6256',
      '--dl-text-muted': '#74877b',
      '--dl-support': '#7BA891',
      '--dl-danger': '#c0392b',
      '--dl-selection': 'rgba(36,155,118,0.14)',
    },
  },
];
