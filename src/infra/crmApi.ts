...
export const crmApi = {
  ...
  profile: async (id: string, params: { from?: string; to?: string } = {}) => data(await apiClient<{ data: Record<string, unknown> }>(`/api/crm/clients/${id}${query(params)}`, 'GET', undefined, token())),
